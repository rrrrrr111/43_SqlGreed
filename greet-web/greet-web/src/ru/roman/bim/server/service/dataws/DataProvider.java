 ...
 * 8  Ревертим URL в greet-web\war\wsdl\DataProvider.wsdl
 * 9. Правим код на клиенте под новые изменения.
 * 10. Переключаем клиент на боевой режим, но на адрес тестового сервера, проверяем функциональность.
 * 11. Если менялись классы сохраняемые через Castor, правим конфиг CastorMappings.xml
 *
 * */
@WebService
