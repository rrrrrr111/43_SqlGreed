...
public class BimItemModel implements Serializable {
    ...
    /**
     * ћожет принимать значение
     * _ - в этом случае в Ѕƒ хранитс€ null, а в модель кладетс€ _
     *      символ означает что на клиенте долежн выполн€тьс€ автоматический перевод
     * _?? - (планируема€ реализаци€) прописываетс€ число возможных переводов
     *      дл€ отображени€ на клиенте, число возможных переводов в Ѕƒ хранитс€ в отдельном поле
     *      , либо будем писать сразу в отображаемый текст
     *
     */
